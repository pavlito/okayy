...
| translations | Translation overrides for button labels, keyword label, and screen reader text | - |
| spinner | Custom spinner element for all dialogs. Set to `false` to hide. | - |
