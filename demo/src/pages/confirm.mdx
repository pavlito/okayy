...
<Preview
  ...
  action={() => confirm.custom((close) => React.createElement('div', { style: { padding: '1.5rem' } },
    React.createElement('h3', { style: { margin: '0 0 0.5rem', fontWeight: 600, fontSize: '1rem', color: 'var(--affirm-title-color)' } }, 'Custom Dialog'),
    React.createElement('p', { style: { margin: '0 0 1rem', color: 'var(--affirm-desc-color)', fontSize: '0.875rem' } }, 'This is fully custom content rendered inside the dialog.'),
